...
class AbstractSubmissionForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'abstract_file': forms.ClearableFileInput(attrs={'accept': '.doc,.docx', 'class': 'form-control'}),
    ...
    def clean_abstract_file(self):
        ...
        if file:
            ...
            if file.content_type not in allowed_types:
                raise ValidationError("Unsupported file type. Upload Word document (.doc, .docx).")
        return file
